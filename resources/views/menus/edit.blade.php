    ...
    <div class="w-full max-w-md p-5 bg-white rounded-lg shadow-md mx-auto">
        ...
        <form method="POST" action="{{ route('menus.update', $menu->id) }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <input type="number" name="price" id="price" value="{{ $menu->price }}" required step="0.01" 
                    class="w-full mt-2 px-4 py-2 border border-gray-300 rounded-md focus:ring-[#6B3109] focus:border-[#6B3109] focus:outline-none transition duration-200 ease-in-out">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3" required 
                    class="w-full mt-2 px-4 py-2 border border-gray-300 rounded-md focus:ring-[#6B3109] focus:border-[#6B3109] focus:outline-none transition duration-200 ease-in-out">{{ $menu->description }}</textarea>
